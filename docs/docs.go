    ...
    "paths": {
        ...
        "/clients": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Client loyalty tier",
                        "name": "loyalty_tier",
                        "in": "query"
                    }
                ],
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/entity.SKUCategory"
                            }
                        }
                    },
                    "500": {
        ...
        "/sku-categories/{id}": {
            ...
            "put": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid input or category cannot be its own parent",
                        "schema": {
                            "$ref": "#/definitions/server.ErrorResponse"
                        }
                    },
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Cannot delete category with children or used by SKUs",
                        "schema": {
                            "$ref": "#/definitions/server.ErrorResponse"
                        }
                    },
        ...
        "/skus": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid input or SKU code",
                        "schema": {
                            "$ref": "#/definitions/server.ErrorResponse"
                        }
                    },
                    "409": {
                        "description": "Duplicate SKU code",
                        "schema": {
                            "$ref": "#/definitions/server.ErrorResponse"
                        }
                    },
        ...
        "/stocks": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Expiry date from (RFC3339 format)",
                        "name": "expiry_date_from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Expiry date to (RFC3339 format)",
                        "name": "expiry_date_to",
                        "in": "query"
                    }
                ],
        ...
        "/stocks/batch-stock-entries": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Array of stock entry details",
                        "name": "entries",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/entity.VendorRating"
                            }
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "entity.SKU": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/entity.SKUStatus"
                },
                "technical_specs": {
        ...
        "entity.SalesOrder": {
            ...
            "properties": {
                ...
                "client": {
                    "description": "Using User as Client for now",
                    "allOf": [
                        {
                            "$ref": "#/definitions/entity.User"
                        }
        ...
        "entity.Store": {
            ...
            "properties": {
                ...
                "type": {
                    "$ref": "#/definitions/entity.StoreType"
                },
                "updated_at": {
                    "type": "string"
                }
